%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% 1D  triangular FMM with adaptive domain partition and local shifting  %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [zl, zu, nflops] = trifmm1d_local_shift(r, x, y, q, gap, org, fun, scaling)
...
% x and y are interlacing:
%                                      y_i < x_i < y_{i+1} < x_{i+1}
...
% org(i) = i or i+1 ( the shift for x(i) )
% gap(i) = x(i) - y(org(i))
...
% zl: tril(K)*q        % lower triangular part
% zu: triu(K,1)*q   % strict upper triangular part
...
%%%%%%%%%%%%%%  (test only)!!!!!!!!!!!!!!! %%%%%%%%%%%%%%
% gap = x - y(org);               %%% if uncommented, no local shifting
%%%%%%%%%%%%%% !!!!!!!!!!!!!!! %%%%%%%%%%%%%%
